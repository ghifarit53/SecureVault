                                            ...
                                            <tr class="inner-box">
                                                ...
                                                @if(isset($userRequests))
                                                    @php
                                                        ...
                                                        $encryptedKey = ($userPublicKey) ? Illuminate\Support\Facades\Crypt::encryptString($file->key, false, ['public_key' => $userPublicKey]) : '';
                                                    @endphp

                                                    <td>
                                                        <div class="evnet-wrap">
                                                            <h3 style="box-sizing: border-box; word-break: break-all; max-height: 100px; max-width: 100px overflow: auto; white-space: pre-wrap">{{$encryptedKey}}</h3>
                                                        </div>
                                                    </td>
                                                @endif
                                                ...
                                                <td>
                                                    <a href="{{ route('download_page', ['id' => $file->id]) }}"
